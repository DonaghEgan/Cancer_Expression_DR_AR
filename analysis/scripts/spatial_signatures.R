...
IFNG <- find_common_genes(list(
  ...
  my_data_list[["fgsea_opacin_H_cancer.Rds"]]$leadingEdge[[27]]
))
...
IFNA <- find_common_genes(list(
  ...
  my_data_list[["fgsea_opacin_H_cancer.Rds"]]$leadingEdge[[26]]
))
...
MYC <- find_common_genes(list(
  ...
  my_data_list[["fgsea_opacin_H_cancer.Rds"]]$leadingEdge[[32]]
))
...
MHCII <- find_common_genes(list(
  ...
  my_data_list[["fgsea_opacin_R_cancer.Rds"]]$leadingEdge[[777]]
))
...
write_csv(gene_pathway_df, "data/processed/pathway_genes_3datasets.csv")

#-------------------------------------------------------------------------------
# AR _ DR _ Signatures
#-------------------------------------------------------------------------------

DR_AR_hmf <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/hmf_deseq_purity_nf_aq_deg.Rds")
AR_PR_hmf <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/hmf_deseq_purity_ar_pr_deg.Rds")
DR_PR_hmf <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/hmf_deseq_purity_nf_pr_deg.Rds")

DR_AR_liu <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/liu_deseq_purity_nf_aq_deg.Rds")
AR_PR_liu <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/liu_deseq_purity_ar_pr_deg.Rds")
DR_PR_liu <- readRDS("Z:/working/GEL_MELANOMA/External_Datasets/HMF_GCP/RNA_seq_processed/OUTPUT/liu_deseq_purity_nf_pr_deg.Rds")
